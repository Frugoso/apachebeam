...
public class prueba {
  ...
  public static void main(String[] args) {
    ...
    // For BlockingDataflowRunner, set project and temp location as follows:
       ...
       dataflowOptions.setProject("gothic-concept-314117");
       dataflowOptions.setTempLocation("gs://pruebafranbuk/your-files/temp_dir");
    ...
    .withDataSourceConfiguration(JdbcIO.DataSourceConfiguration.create(
           "com.microsoft.sqlserver.jdbc.SQLServerDriver", "jdbc:sqlserver://35.224.107.222:1433;databaseName=titanic")
         .withUsername("sqlserver")
         .withPassword("titanic"))
    .withQuery("select * from dbo.titanic")
    ...
    .withRowMapper(new JdbcIO.RowMapper<KV<Integer, String>>() {
      public KV<Integer, String> mapRow(ResultSet resultSet) throws Exception {
        ...
        .apply(TextIO.write().to("gs://pruebafranbuk/pruebatitanic.txt"));
